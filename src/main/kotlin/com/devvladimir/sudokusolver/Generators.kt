...
fun rowCoordinateGenerator(rowNumber:Int):Generator =
    {index -> Coordinate(x = rowNumber, y = index) }

fun colCoordinateGenerator(colNumber:Int):Generator =
    {index ->Coordinate(x = index, y = colNumber)}
